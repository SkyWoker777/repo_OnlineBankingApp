...
{
    public sealed partial class OnVisaCardAnyBankPage : Page
    {
        public OnVisaCardAnyBankPage()
        {
            this.InitializeComponent();
            this.Loaded += OnVisaCardAnyBankPage_Loaded;
        }

        private void OnVisaCardAnyBankPage_Loaded(object sender, RoutedEventArgs e)
        {
            this.DataContext = new OnVisaCardAnyBankViewModel();
        ...
        {
            var vm = (OnVisaCardAnyBankViewModel)DataContext;
